...
const Form = () => {
  ...
  return (
    <div className="container mx-auto p-6 text-center">
      <div className="max-w-md mx-auto justify-center p-6 flex bg-gray-100 mt-4 rounded shadow-xl">
        <form className="w-full" action="" onSubmit={handleLogin}>
          <div className="flex flex-col w-full text-left mb-4">
            <label className="form-text mr-2 font-bold text-lg" for="username">
              Username
            </label>
            <input
          ...
          <div className="flex flex-col text-left mb-4">
            <label className="form-text mr-3 font-bold text-lg" for="password">
              Password
            </label>
            <input
              className="border w-full border-blue-400 rounded-md py-2 px-3 text-grey-darknest"
          ...
          <div className="flex flex-col w-full text-left mb-4">
            <label className="form-text mr-2 font-bold text-lg" for="email">
              Email
            </label>
            <input
              className="border w-full border-blue-400 rounded-md py-2 px-3 text-grey-darknest"
          ...
          <div className="flex flex-col w-full text-left mb-4">
            <label className="form-text mr-2 font-bold text-lg" for="company">
              Company Name
            </label>
            <input
          ...
          <div className="flex flex-col w-full text-left mb-4">
            <label className="form-text mr-2 font-bold text-lg" for="category">
              category
            </label>
            <select
              className="border w-full border-blue-400 rounded-md py-2 px-3 text-grey-darknest"
